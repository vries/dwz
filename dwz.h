/* Copyright (C) 2001-2021 Red Hat, Inc.
   ...
   Written by Jakub Jelinek <jakub@redhat.com <mailto:jakub@redhat.com>>, 2012.
...
extern dw_cu_ref first_cu, last_cu;

extern dw_cu_ref alt_first_cu;

extern struct obstack ob2;
...
extern void *pool_alloc_1 (unsigned int align, unsigned int size);

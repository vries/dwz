...
/* Helper function of partition_dups_1.  Decide if the partition ARR[I..J-1]
   with CNT referrer CUs might be worthwhile to be moved to a partial unit,
   and construct it.  Return true during the first phase, if the second phase
   needs to be run.  */
static bool
...
/* Helper function of partition_dups.  For each partition, call
